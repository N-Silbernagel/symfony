...
class MultiOutputTest extends TestCase
{
    protected MultiOutput $multiOutput;

    protected function setUp(): void
    {
        $this->multiOutput = new MultiOutput([]);
    }
    ...
    {
        $output = new MultiOutput($this->stream, Output::VERBOSITY_QUIET, true);
